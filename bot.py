...
training_data_file = st.file_uploader("Upload training data (JSON)", type=["json"])
...
testing_data_file = st.file_uploader("Upload testing data (JSON)", type=["json"])
if testing_data_file is not None:
    testing_data = json.load(testing_data_file)
